  ...
  <div>
    ...
    <div class="flex flex-col lg:flex-row gap-8 max-w-content mx-auto px-4">
      <div class="font-manrope text-gray-blue text-body flex-1 lg:max-w-text-column">
        ...
        <p class="leading-normal mb-0">
          <span class="font-semibold">Если коротко, </span><span class="font-extrabold">Симвология — это</span><span
          class="font-semibold"> про то, почему какой-нибудь странный крючочек на стене может знать о мире больше, чем мы сами.</span>
        </p>
        <p class="leading-normal mb-0">
          <span
            class="font-semibold">Если длинно… ну, об этом мы поговорим на занятиях. Возможно, даже не один раз. </span><span
          class="font-semibold line-through">И, честно, я сам надеюсь понять хоть что-то.</span>
        </p>
        <br/>

        <p class="leading-normal mb-0">
          <span class="font-extrabold">Здесь мы будем разбираться</span><span
          class="font-semibold"> в смысловых хитросплетениях, философствовать, спорить, находить символы там, где их быть не должно, — и делать вид, что это всё абсолютно нормально.</span>
        </p>
        <br/>

        <p class="font-semibold leading-normal mb-0">
          Я люблю хорошие истории, неожиданные вопросы и моменты, когда студенты говорят: «Ооо, теперь понятно».
        </p>
        <p class="font-semibold leading-normal mb-0">
          А ещё — моменты, когда они говорят: «Вообще не понятно, но прикольно».
        </p>
        <br/>
      ...
      <div class="flex-1 flex flex-col justify-center items-center">
        <img
          alt="Винди - друг Сайласа Локка"
          class="w-full max-w-36 lg:max-w-72 object-contain pointer-events-none"
          src="/images/vindi-illustration.png"
        />
        <p class="font-manrope font-semibold leading-normal text-gray-blue text-body text-center lg:text-left mt-6 max-w-image-caption">
          мой друг Винди. Создал его... а на одной из лекций и расскажу!
        </p>
      </div>
    </div>
  </div>
