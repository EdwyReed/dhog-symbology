  ...
  <div class="lecture-container">
    ...
    <article class="lecture-content text-justify">
      ...
      <ol class="list-ordered">
        <li>
          <span class="font-extrabold">Смысл = сила.</span> Смысл — это то, за счёт чего символ вообще работает. Ему не требуется разрешение или глубокое понимание; контакт происходит сразу, как только ты с ним сталкиваешься. Разница лишь в том, осознаёшь ли ты, что происходит, или просто оказываешься втянутым. Когда смысл ясен, ты действуешь осознанно.
        </li>
        <li>
        ...
        <ol class="list-ordered">
          <li class="mb-4">
            ...
            <ul class="list-disc ml-6 mt-2 space-y-1">
              ...
              <li>какой закон Символогии был проигнорирован и как именно</li>
            </ul>
            <p class="mt-2">
